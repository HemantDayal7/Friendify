        ...
        try:
            with open(file_name, 'r') as file:
                ...
                for i in range(num_members):
                    ...
                    # Create lists for friends if not already present
...
class Friendship:
    ...
    def least_friends_str(self):
        ...
        return f"Users with the least friends: {least_friends}\nMembers with zero friends: {zero_friends}"

if __name__ == "__main__":
    # Code to load the social network
    sn = SocialNetwork()

    # Code to loop through file names until the user enters 'n'
    while True:
        ...
        if success:
            ...
            if display_network == "y":
                sn.display_network()
            friendship = Friendship(sn.network)  # Create an instance of the Friendship class
